...
[[sec.benchmarks.T3D_graphic]]
===== TRACE 3D Graphic Interface

An example of TRACE 3D graphic interface is shown in <<fig_trace>>.
...
[[fig_trace,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/Trace.png[scaledwidth=12cm,width=90%]
...
sigma-matrix structure is shown in <<fig_trace_z>>.

.Sigma-matrix structure in TRACE 3D <<bib.TraceMan>>
[[fig_trace_z,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/TRACE_z.png[scaledwidth=12cm,width=90%]
...
interface <<bib.Transport_GUI>> is shown in <<fig_TRANSPORT>>.
...
[[fig_TRANSPORT,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/TRANSPORT.png[scaledwidth=12cm,width=90%]

[[sec.benchmarks.T3D_TRAN]]
...
[[fig_Input_TRACE,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/Input_Trace.png[scaledwidth=8cm,width=33%]

The corresponding sigma-matrix with the relative units is displayed by
command Z:

.TRACE 3D sigma-matrix for the  beam
[[fig_TRACE_z_Input,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/TRACE_z_input.png[scaledwidth=12cm,width=50%]
...
[[tab_Bend_Trace,Table {counter:tab-cnt}]]
...
[[tab_Edge_Trace,Table {counter:tab-cnt}]]
[cols="<1,<1,<2",options="header",]
|=======================================================================
|Parameter |Value |Description
...
phase planes for this simulation are shown in <<fig_Trace_env>>.
...
[[fig_Trace_env,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/Trace_SBEND_edge.png[scaledwidth=18cm,width=90%]

[[sec.benchmarks.sbend-in-transport]]
===== SBEND in TRANSPORT
...
[[tab_transport_bending_magnet,Table {counter:tab-cnt}]]
[cols="<1,<1,<2",options="header",]
|=====================================================
|Parameter |Value |Description
...
[[fig_Tran_env,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/TRANS_SBEND_edge.png[scaledwidth=12cm,width=90%]

[[sec.benchmarks.beam-size-and-emittance-comparison]]
...
[[tab_transport_transveral_beam_size,Table {counter:tab-cnt}]]
[cols="<,<,<,<,<,<",]
|=======================================================================
...
[[fig_T3D_Tra_env,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/T3D_Tra_SBEND_edge_env.png[scaledwidth=12cm,width=60%]
...
[[fig_T3D_Tra_emi,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/T3D_Tra_SBEND_edge_emi.png[scaledwidth=12cm,width=60%]

[[sec.benchmarks.T3DtoTRAN]]
===== From TRACE 3D to TRANSPORT

.Bending magnet features in TRACE 3D and TRANSPORT
[[tab_transport_trace_3d,Table {counter:tab-cnt}]]
[cols="<,<,<",options="header",]
|==============================================================
...
line described in <<sec.benchmarks.T3D_TRAN>> has been simulated in _OPAL_ using
...
[[fig_trace3d_comparison_without_edge_angles,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/SBEND_noEdge.png[scaledwidth=18cm,width=90%]
+
...
[[fig_trace3d_comparison_with_edge_angles,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/SBEND_Edges.png[scaledwidth=18cm,width=90%]
+
...
++++
+
<<sec.elements.RBend,RBend (_OPAL-t_)>>. Instead, in TRACE 3D the field index parameter n is:
+
[latexmath]
++++
...
[[fig_SBEND_FI,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/FI_SBEND_FMDef.png[scaledwidth=18cm,width=90%]
+
...
shown in <<fig_SBEND_FI_test>>, is achieved using a test field map in
...
[[fig_SBEND_FI_test,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/FI_SBEND_FMTest.png[scaledwidth=18cm,width=90%]

[[sec.benchmarks.T3DtoOPAL]]
===== From TRACE 3D to _OPAL-t_

.Bending magnet features in TRACE 3D and __OPAL-t__
[[tab_bending_magnet_TRACE3d_OPAL,Table {counter:tab-cnt}]]
[cols="<,<,<",options="header",]
|==============================================================
...
TRACE 3D emittance see <<fig_SBEND_FI_test>>.

[[sec.benchmarks.hard-edge-dipole-comparison-with-elegant]]
=== Hard Edge Dipole Comparison with ELEGANT

[[sec.benchmarks.opal-dipole]]
==== _OPAL_ Dipole
...
Please refer to <<sec.fieldmaps.1DProfile1,`1DProfile1`>> for the definition of the field map
...
[[sec.benchmarks.map-for-hard-edge-dipole]]
...
[[fig_plot-compare-default,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/report-compare-default.png[scaledwidth=12cm,width=70%]

<<fig_plot-compare-default>> compares the emittances and beam sizes
...
[[sec.benchmarks.integration-time-step]]
...
<<fig_plot-emit-dt>> compares the normalized emittances generated using
...
outside the fringe field regions. In <<fig_plot-emit-dt>>, one can
...
[[fig_plot-emit-dt,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/report-emit-dt.png[scaledwidth=12cm,width=66%]

<<fig_plot-fringe-size>> and <<fig_plot-fringe-size-zoom>> examine the effects of
the fringe field range and the integration time step on the simulation
accuracy. <<fig_plot-fringe-size-zoom>> is a zoom-in plot of
<<fig_plot-fringe-size>>. We can conclude that the size of the
...
[[fig_plot-fringe-size,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/report-fringe-size.png[scaledwidth=12cm,width=66%]

.Zoom in on the final emittance in <<fig_plot-fringe-size>>
[[fig_plot-fringe-size-zoom,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/report-fringe-size-zoom.png[scaledwidth=12cm,width=66%]

[[sec.benchmarks.1d-csr-comparison-with-elegant]]
...
effect is turn off, <<fig_plot-emit-csr-off>> shows that the normalized
...
[[fig_plot-emit-csr-off,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/emit-csr-off.png[scaledwidth=12cm,width=66%]

When CSR calculations are enabled for both the bending magnet and the
following drift, <<fig_plot-dpp-csr-on>> shows the average
latexmath:[\delta] or latexmath:[\frac{\Delta p}{p}] change along
the beam line, and <<fig_plot-emit-csr-on>> compares the normalized
...
[[fig_plot-dpp-csr-on,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/dpp-csr-on.png[scaledwidth=12cm,width=66%]
...
horizontal emittances as indicated in <<fig_plot-emit-csr-on>>.

.Transverse emittances in ELEGANT and __OPAL__
[[fig_plot-emit-csr-on,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/emit-csr-on.png[scaledwidth=12cm,width=66%]
...
[prstab2003]. In <<fig_plot-emit-csr-on>>, a trace-like horizontal
...
<<fig_plot-opal-impact1>> and <<fig_plot-opal-impact2>>. This proves to some extend
...
[[fig_plot-opal-impact1,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/opal-impact-1MHz.png[scaledwidth=18cm,width=100%]

.Longitudinal beam size and emittance in `Impact-t` and __OPAL__
[[fig_plot-opal-impact2,Figure {counter:fig-cnt}]]
image::figures/Benchmarks/opal-impact-1MHz-z.png[scaledwidth=10cm,width=50%]

[[sec.benchmarks.bibliography]]
=== References

anchor:bib.TraceMan[[{counter:bib-cnt}\]]
<<bib.TraceMan>> K. Crandall and D. Rusthoi, https://doi.org/10.2172/5937743[_Documentation for TRACE: An Interactive Beam-Transport Code_], Tech. Rep. LA—10235-MS, Los Alamos National Laboratory (1985).

anchor:bib.transport[[{counter:bib-cnt}\]]
<<bib.transport>> K. L. Brown et al., http://cds.cern.ch/record/133647[_TRANSPORT - A Computer Program for Designing Charged Particle Beam Transport Systems_], Tech. Rep. CERN 80-4, European Organization for Nuclear Research (1980).

anchor:bib.Transport_GUI[[{counter:bib-cnt}\]]
<<bib.Transport_GUI>> U. Rohrer, http://aea.web.psi.ch/Urs_Rohrer/MyWeb/trans.htm[_PSI graphic transport framework based on a CERN-SLAC-FERMILAB version by K.L. Brown et al_].

anchor:bib.Tran_ex[[{counter:bib-cnt}\]]
<<bib.Tran_ex>> U. Rohrer, http://aea.web.psi.ch/Urs_Rohrer/MyWeb/moregifs/gantryb.gif.

anchor:bib.elegant[[{counter:bib-cnt}\]]
<<bib.elegant>> M. Borland, https://publications.anl.gov/anlpubs/2000/08/36940.pdf[_elegant: a flexible SDDS-compliant code for accelerator simulation_], Tech. Rep. LS-287, Advanced Photon Source (2000).
