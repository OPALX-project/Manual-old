...
[appendix]
[[appendix.autophasing]]
== Auto-phasing Algorithm

[[sec.autophasing.standing-wave-cavity]]
...
<<eq-rulelag>>. Next a better model for the kinetic Energy can be
calculated using
...
[[sec.autophasing.traveling-wave-structure]]
=== Traveling Wave Structure

.Field map ’FINLB02-RAC.T7’ of type 1DDynamic
[[fig_FINLB,Figure {counter:fig-cnt}]]
image::figures/autophase/field_crop.png[scaledwidth=12cm,width=60%]
...
<<eq-Gamma1>> and <<eq-Gamma2>> there are four sums with different numbers of
summands.
...
[[sec.autophasing.alternative-approach-for-traveling-wave-structures]]
